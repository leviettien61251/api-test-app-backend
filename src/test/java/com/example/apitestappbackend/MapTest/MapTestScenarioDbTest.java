...
//
//    @Test
//    @DisplayName("Testcase 6: Building alreay exist - Should PASS (Validation fails)")
//    void testMapTestBuidlindAlreadyExists() {
//        // Arrange
//        MapTestRequest request = new MapTestRequest(
//                VALID_BUILDING_CODE,
//                VALID_BUILDING_NAME,
...
//        );
//
//        mapTestService.insertMapTest(request);
//
//        // Act
//        MapTestResponse response = mapTestService.insertMapTest(request);
//
...
//        assertNotNull(response, "Response should not be null");
//        assertEquals("fail", response.getStatus(), "Status should be fail");
//        assertEquals(ResponseCode.BUILDING_EXISTS.getCode(), response.getCode(), "Response code should be 2003");
//        assertNotNull(response.getMessage(), "Message should not be null");
//        assertFalse(response.getUsedInTest());
//
//        // Verify no record is saved
//        assertTrue(mapTestRepository.findByBuildingCode(VALID_BUILDING_CODE).size() > 0, "No record should be saved because building already exists");
//    }
//
//    @Test
